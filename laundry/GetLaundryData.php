...
$sql = "SELECT laundry_name, laundry_email, laundry_phone, laundry_picture, laundry_hours, laundry_rating, laundry_location  FROM laundry WHERE laundry_id = '" . $laundry_id . "' ";
